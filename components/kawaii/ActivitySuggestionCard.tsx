...
const budgetColors: Record<string, string> = {
  free: 'hsl(153 62% 83%)',
  budget: 'hsl(153 62% 83%)',
  moderate: 'hsl(212 100% 86%)',
  'mid-range': 'hsl(212 100% 86%)',
  premium: 'hsl(259 100% 85%)',
  luxury: 'hsl(340 100% 86%)',
};
...
const ActivitySuggestionCard = ({ activity }: { activity: KawaiiActivity }) => {
      ...
      <div className="p-4 pt-3">
        ...
        <div className="flex items-center gap-2 flex-wrap mb-3">
          <span
            ...
            style={{ backgroundColor: budgetColors[activity.budget_tier] ?? 'hsl(153 62% 83%)' }}
          >
            {budgetLabels[activity.budget_tier] ?? activity.budget_tier}
          </span>
