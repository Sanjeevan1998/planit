...
import type { PlanningStep } from '@/stores/useTripStore';
          ...
          <div key={step.key} className="flex items-center">
            <motion.div
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-pill text-xs font-heading font-bold transition-colors ${
                active ? 'bg-foreground text-background' : done ? 'bg-primary/30 text-foreground' : 'bg-muted text-muted-foreground'
              }`}
